	...
	render() {
		return (
			<div>
			  ...
			  {this.state.step == 'outer' && <Outer handleContinue={this.handleStepClick.bind(this, 'inner') } mode={'edit'} />}
			  {this.state.step == 'inner' && <Inner handleContinue={this.handleStepClick.bind(this, 'test') } handlePrevious={this.handleStepClick.bind(this, 'outer')} mode={'edit'} />}
			  {this.state.step == 'test' && <Test handleContinue={this.handleStepClick.bind(this, 'doc')} handlePrevious={this.handleStepClick.bind(this, 'inner')} mode={'edit'} />}
			  {this.state.step == 'doc' && <Doc handleContinue={this.handleStepClick.bind(this, 'pub')} handlePrevious={this.handleStepClick.bind(this, 'test')} mode={'edit'} />}
			  {this.state.step == 'pub' && <Pub handlePrevious={this.handleStepClick.bind(this, 'doc')} mode={'edit'} />}
